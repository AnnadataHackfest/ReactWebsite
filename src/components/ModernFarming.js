...
function ModernFarming(){
    return (
        <div>
          <Container>
          <div style={{textAlign: "center"}}><h3>Modern Farming Videos and Techniques</h3></div>
          <hr />
              ...
              <div style={{textAlign: "center"}}><h3>Multiple and Sustainable Farming</h3></div>
              <hr />
              <Row style={{marginTop: "3rem", marginBottom: "3rem"}}>
                  <Col>
                  <iframe width="300" height="200" src="https://www.youtube.com/embed/OAVINQQDSJ8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </Col>
                  <Col>
                  <iframe width="300" height="200" src="https://www.youtube.com/embed/T5KhzfBAbzg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </Col>
                  <Col>
                  <iframe width="300" height="200" src="https://www.youtube.com/embed/VOBwgDttas0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                  </Col>
              </Row>
              <div style={{textAlign: "center"}}><h3>Modern Farming Tools</h3></div>
              <hr />
              <Row style={{marginTop: "3rem", marginBottom: "3rem"}}>
                  <Col>
              ...
              <div style={{textAlign: "center"}}><h3>Crop Combination Inspirations</h3></div>
              <hr />
              <Row style={{marginTop: "3rem", marginBottom: "3rem"}}>
                  <Col>
          ...
          <div style={{textAlign: "center", marginTop: "3rem", marginBottom: "2rem"}}><h5>Stay Tuned for more inspiring videos :)</h5></div>
        </div>
    );
}
